...
QT5WEBENGINE_SOURCE = qtwebengine-everywhere-src-$(QT5WEBENGINE_VERSION).tar.xz # http://sources.buildroot.net/qt5webengine/qtwebengine-everywhere-src-5.15.2.tar.xz
